...
public class DummyClient {
  ...
  /** Logger. */
  private static final Logger logger = LogManager.getLogger( "DummyClient" );
  ...
  public static void main( String[] args )
    ...
    // Scenario name.
    String scenarioName = "DummyClientScenario";

    // Group name.
    String groupName = "DummyClientDemo";

    // Client name.
    String clientName = "DummyClient";
    ...
    // Data service name.
    String serviceName = "DummyClientDataService";
    ...
    DummyClientData dataService = new DummyClientData();
    ...
    // Add notifier.
    dataService.addStateChangeNotifier( new DummyClientNotifier() );
   ...
   */
  static class DummyClientData extends LlServiceString {
    /**
  ...
  /**
   * Class DummyClientNotifier.
   */
  static class DummyClientNotifier implements IServiceStateChangeNotifier<LlService, String> {
    /**
